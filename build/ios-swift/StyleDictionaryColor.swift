...
public enum StyleDictionaryColor {
    public static let colorprimary = UIColor(red: 0.510, green: 0.216, blue: 0.988, alpha: 1)
    ...
    public static let colorsSemiRed = UIColor(red: 0.667, green: 0.141, blue: 0.024, alpha: 1)
    ...
    public static let colorsecondary = UIColor(red: 0.239, green: 0.110, blue: 0.400, alpha: 1)
