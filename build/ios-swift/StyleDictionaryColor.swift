...
// Generated on Sun, 28 May 2023 13:34:09 GMT


import UIKit

public enum StyleDictionaryColor {
    public static let colorprimary = UIColor(red: 0.216, green: 0.616, blue: 0.988, alpha: 1)
    public static let colorprimarytext = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1)
    ...
    public static let colorsSemiRed = UIColor(red: 1.000, green: 0.373, blue: 0.016, alpha: 1)
    ...
    public static let colorsecondary = UIColor(red: 0.176, green: 0.192, blue: 0.525, alpha: 1)
    public static let colorsecondarytext = UIColor(red: 0.851, green: 0.851, blue: 0.851, alpha: 1)
}
